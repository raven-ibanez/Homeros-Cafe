    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-xl shadow-sm overflow-hidden mb-8">
        {cartItems.map((item, index) => (
          <div key={item.id} className={`p-6 ${index !== cartItems.length - 1 ? 'border-b border-cafe-beige' : ''}`}>
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-4 ml-4">
                <div className="flex items-center space-x-3 bg-cafe-beige/30 rounded-full p-1 border border-cafe-beige">
                  <button
                    onClick={() => updateQuantity(item.id, item.quantity - 1)}
                    className="p-2 hover:bg-cafe-beige/50 rounded-full transition-colors duration-200"
                  >
                ...
                <button
                  ...
                  className="p-2 text-cafe-accent hover:text-cafe-brown hover:bg-cafe-beige/20 rounded-full transition-all duration-200"
                >
